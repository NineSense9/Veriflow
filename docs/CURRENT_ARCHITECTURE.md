...
日期：2026-09-10  
范围：本文件只描述**已经存在并运行**的代码，不描述赛题 Prompt 里假设的 n8n / Dify 产品。
...
**不存在的目录（Prompt 假设，本仓库没有）：** `veriflow/spec`、`veriflow/ir` 独立树、n8n adapter、SMT/Z3、跨模型 workflow 生成平台、独立 Benchmark Dashboard 应用。
